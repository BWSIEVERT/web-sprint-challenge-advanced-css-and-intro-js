...
console.log(get20s(artists, '1471'));
...
function addArtist(id, name, years, genre, nationality, bio){
  ...
  let myArtistInfo = addArtist(20, 'Brandon Sievert', '1997 - current day', 'Web Design', 'American', 'Just a guy that loves coffe and enjoys life. My favorite quote: I believe theres a hero in all of us, that keeps us honest, gives us strength, makes us noble. And finally gets us to die with pride. Even though sometimes we have to be steady and give up the thing we want most, even our dreams.')
  console.log(myArtistInfo);
